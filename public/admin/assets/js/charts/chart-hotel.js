!(function (NioApp, $) {
    ...
    var totalBooking = {
        ...
        datasets: [{
            label: "User",
            color: [NioApp.hexRGB("#816bff", .2), "#816bff"], // Example color
            data: bookingData.map(item => item.total)
        }]
    };
    
    var totalRoom = {
        labels: roomData.map(item => item.date),
        dataUnit: 'Room',
        stacked: true,
        datasets: [{
            label: "User",
            color: [NioApp.hexRGB("#6576ff", .2), "#6576ff"], // Example color
            data: roomData.map(item => item.available)
        }]
    };
    ...
    var totalExpenses = {
        ...
        datasets: [{
            label: "Expenses",
            color: [NioApp.hexRGB("#559bfb", .2), "#559bfb"], // Example color
