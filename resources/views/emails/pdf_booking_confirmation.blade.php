                    ...
                    <div class="payment-room">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 50%; margin-top:30px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="order-complate text-center button-group">
                                    <a href="https://maps.app.goo.gl/v1UmFYzWzzxMV5Gd6" target="_blank"><img src="https://i.ibb.co/sWMJR9F/map.png" alt="Map" style="vertical-align: middle; margin-right:5px;">The Rock Resorts, Pulau Aur, 86800 Mersing, Johor, Malaysia</a>
                                </div>
                            </div>
                        </div>
                    </div>
