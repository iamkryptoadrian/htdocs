                                        ...
                                        <div class="nk-data data-list">
                                            ...
                                            <div class="data-item">
                                                <div class="data-col">
                                                    ...
                                                    <span
                                                        class="data-value">{{ Auth::guard('admin')->user()->email }}</span>
                                                </div>
                                                <div class="data-col data-col-end"><span class="data-more"><em
                                                            class="icon ni ni-forward-ios"></em></span></div>
                                            </div><!-- data-item -->
                                    ...
                                    <div class="card-inner-group" data-simplebar>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="#"><em
                                                                            class="icon ni ni-edit-fill"></em><span>For
                                                                            Future</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-inner">
                                            <div class="user-account-info py-0">
                                                ...
                                                <div class="user-balance">0.00 <small
                                                        class="currency currency-btc">ENVI</small></div>
                                                <div class="user-balance-sub">Admin does not need wallet</span></div>
                                            </div>
                                        </div><!-- .card-inner -->
                                        <div class="card-inner p-0">
                                            <ul class="link-list-menu">
                                                ...
                                                <li><a href=""><em class="icon ni ni-lock-alt-fill"></em><span>2FA
                                                            Settings</span></a></li>
                                            </ul>
                                        </div><!-- .card-inner -->
                    ...
                    <div class="modal-body modal-body-lg">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="personal">
                                <form method="POST" action="{{ route('admin.adminupdate') }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row gy-4">
                                        <!-- Full Name -->
