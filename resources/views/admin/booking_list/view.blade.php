                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Booking / <strong
                                        class="text-primary small">{{ $booking->booking_id }}</strong></h3>
                            ...
                            <div class="card-aside-wrap">
                                <div class="card-content scrollable_table">
                                    <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#tabSupport"><em
                                                    class="icon ni ni-chat-circle"></em><span>Support</span></a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div class="tab-pane active" id="tabRoomDetails">
                                                ...
                                                <div class="nk-block">
                                                    <div class="nk-block-head nk-block-head-sm nk-block-between">
                                                        <h5 class="title">Admin Private Notes</h5>
                                                        <a href="#add-admin_note" data-bs-toggle="modal"
                                                            ...
                                                            <div class="bq-note-item">
                                                                ...
                                                                <div class="bq-note-meta">
                                                                    <span class="bq-note-added">Added on <span
                                                                            class="date">{{ $note->created_at->format('F d, Y') }}</span>
                                                                        at <span
                                                                            class="time">{{ $note->created_at->format('g:i A') }}</span></span>
                                                                    <span class="bq-note-sep sep">|</span>
                                                                    <span class="bq-note-by">By
                                                                        <span>{{ $note->author->name ?? 'Admin' }}</span></span>
                                                                    <a href="#" class="link link-sm link-danger"
                                                                        onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this note?')) document.getElementById('delete-note-form-{{ $note->id }}').submit();">Delete
                                                                        Note</a>
                                                                    <form id="delete-note-form-{{ $note->id }}"
                                                                        action="{{ route('admin.notes.delete', ['id' => $note->id]) }}"
                                            ...
                                            <div class="tab-pane" id="tabSupport" style="white-space: normal;">
                                                ...
                                                <div class="nk-chat-panel" style="height: 400px">
                                                    @forelse ($messages as $message)
                                                        <div
                                                            class="chat {{ $message->author_type === 'customer' ? 'is-you' : 'is-me' }}">
                                                            <div class="chat-content">
                                                                <div class="chat-bubbles">
                                                                    <div class="chat-bubble">
                                                                        <div class="chat-msg">{{ $message->content }}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <ul class="chat-meta">
                                                                    <li>{{ $message->author_type === 'customer' ? $message->author->first_name . ' ' . $message->author->last_name : 'Customer Support' }}
                                                                    </li>
                                                                    <li>{{ $message->created_at->format('d M, Y H:i A') }}
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <form id="adminMessageForm"
                                                    action="{{ route('admin.booking.replyMessage', $booking->booking_id) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="form-control-wrap">
                                                        <div class="input-group">
                                                            <input
                                                                style="border-bottom: 1px solid #816bff; border-radius: 0;"
                                ...
                                <div class="card-aside card-aside-right user-aside toggle-slide toggle-slide-right toggle-break-xxl"
                                    ...
                                    <div class="card-inner-group" data-simplebar>
                                        ...
                                        <div class="card-inner">
                                            <h6 class="overline-title-alt mb-3">Update Status</h6>
                                            <form action="{{ route('admin.booking.updateStatus', $booking->id) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="booking_status" name="booking_status">
                                                        <option value="Pending For Payment" {{ $booking->booking_status == 'Pending For Payment' ? 'selected' : '' }}>
                                                            Pending For Payment
                                                        </option>
                                                        ...
                                                        <option value="Active" {{ $booking->booking_status == 'Active' ? 'selected' : '' }}>
                                                            Active
                                                        </option>
                                                    </select>
                                                </div>
