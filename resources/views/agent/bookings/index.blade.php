                ...
                <div class="nk-block-between">
                   <div class="nk-block-head-content">
                      ...
                      <div class="nk-block-des text-soft">
                         <p>You have made total {{$totalBookings}} booking's.</p>
                      </div>
                   </div>
                  ...
                  <div class="nk-block-head-content">
                    <ul class="nk-block-tools g-3">
                       <li>
                          <div class="drodown">
                             <a href="{{route('agent.bookings.index')}}" class="btn btn-icon btn-primary"><em class="icon ni ni-plus"></em></a>
                          </div>
                       </li>
                    </ul>
                 </div>
                   ...
                   <div class="card-inner-group">
                      <div class="card-inner position-relative card-tools-toggle">
                               ...
                               <div class="form-inline flex-nowrap gx-3">
                                  <div class="btn-wrap">
                                     <span class="d-none d-md-block">
                                         <a href="{{ route('agent.bookings.index') }}" class="btn btn-dim btn-outline-light">Reset Filters</a>
                                     </span>
                                                 ...
                                                 <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-xs dropdown-menu-end">
                                                         <ul class="link-check">
                                                             ...
                                                             <li class="{{ $recordsPerPage == 10 ? 'active' : '' }}"><a href="{{ route('agent.bookings.index', ['show' => 10, 'order' => $sortOrder, 'sortBy' => $sortBy]) }}">10</a></li>
                                                             <li class="{{ $recordsPerPage == 20 ? 'active' : '' }}"><a href="{{ route('agent.bookings.index', ['show' => 20, 'order' => $sortOrder, 'sortBy' => $sortBy]) }}">20</a></li>
                                                             <li class="{{ $recordsPerPage == 50 ? 'active' : '' }}"><a href="{{ route('agent.bookings.index', ['show' => 50, 'order' => $sortOrder, 'sortBy' => $sortBy]) }}">50</a></li>
                                                          </ul>
                                                          <ul class="link-check">
                        ...
                        <div class="card-search search-wrap" data-search="search">
                            <form method="GET" action="{{ route('agent.bookings.index') }}">
                                <div class="card-body">
                            ...
                            <div class="nk-tb-item">
                                <div class="nk-tb-col">
                                    <span class="text-primary">
                                        <a href="{{ route('agent.bookings.view', ['booking_id' => $booking->booking_id]) }}">{{ $booking->booking_id }}</a>
                                    </span>
                                </div>
