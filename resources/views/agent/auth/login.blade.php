                    ...
                    <div class="nk-split nk-split-page nk-split-md">
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access The Rock Resort Agent Panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div><!-- .nk-block-head -->
                                <form method="POST" action="{{ route('agent.agentlogin') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="flex items-center justify-between">
                                            ...
                                            @if (Route::has('agent.password.request'))
                                                <a href="{{ route('agent.password.request') }}" class="link link-primary link-sm">Forgot Password?</a>
                                            @endif
                                        </div>
                                    </div><!-- .form-group -->
                                ...
                                <div class="form-note-s2 pt-4"> New on our platform? <a href="{{ route('agent.register')}}">Create an account</a></div>
                            </div>
